<x-app-layout title="Fill Machine">
        ...
        <div class="mx-auto w-full max-w-6xl space-y-6">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route('services.machines.fill.store', [$service->id, $machine->id]) }}" class="space-y-5">
                        @csrf
                            ...
                            <table class="min-w-full divide-y divide-gray-200 text-sm dark:divide-gray-700/60">
                                <thead class="bg-gray-50 dark:bg-gray-800/80">
                                    <tr>
                                        ...
                                        <th class="px-5 py-3 text-left font-medium text-gray-500 dark:text-gray-400">Fill Quantity</th>
                                    </tr>
                                </thead>
                        ...
                        <div class="flex items-center justify-end gap-3">
                            ...
                            <x-button :disabled="$machine->bins->isEmpty()">Fill Machine</x-button>
                        </div>
                    </form>
