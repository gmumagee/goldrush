            ...
            <section class="panel">
                <div class="panel-body">
                    @if ($locations->isEmpty())
                        <div class="rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800 dark:border-blue-900/60 dark:bg-blue-500/10 dark:text-blue-300">
                            No locations exist yet. This machine will be assigned to an auto-created default location when saved.
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('machines.store') }}" class="space-y-5">
                        ...
                        <div>
                            ...
                            @if ($locations->isEmpty())
                                <div class="rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-600 dark:border-gray-700/60 dark:bg-gray-800 dark:text-gray-300">
                                    Default Location
                                </div>
                            @else
                        ...
                        <div class="grid gap-5 md:grid-cols-2">
                            <div>
                                ...
                                <x-input id="type" name="type" type="text" :value="old('type')" required />
                            </div>
                        ...
                        <div>
                            ...
                            <x-input id="installed_on" name="installed_on" type="date" :value="old('installed_on')" />
                        </div>
